...
@todo_router.post("/", response_model=todo_schema.Todo)
...
@todo_router.get("/{todo_id}", response_model=todo_schema.Todo)
...
@todo_router.get("/", response_model=list[todo_schema.Todo])
...
@todo_router.put("/{todo_id}", response_model=todo_schema.Todo)
...
@todo_router.get("/{user_id}", response_model=list[todo_schema.Todo])
